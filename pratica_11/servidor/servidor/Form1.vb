...
Public Class Form1
    ...
    Dim caminho_para_pasta_html As String = "C:\Users\Vasco\Documents\MEGAsync\4-2\II\pratica_11\"
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        fs.OpenProject("C:\Users\Vasco\Documents\MEGAsync\4-2\II\pratica_11\facon.fcs")

        cn.ConnectionString = "Server=localhost; User Id=root; Password=Asdfghjkl0; Database=reservatorio"

        ' Verificações de erros de ligação
        Try
            If cn.State = ConnectionState.Closed Then
                cn.Open()
                MsgBox("Ligação Correcta à Base de Dados reservatorio...")
            End If
        Catch ex As Exception
            cn.Close()
            MsgBox("Ligação Incorrecta à Base de Dados reservatorio...")
        End Try
        cmd.Connection = cn
    End Sub
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If connection.Connected Then
            ...
            If texto_recebido.Length > 1 Then
                ...
                cmd.CommandText = "Insert into controlo(Y0, Y1, Y2) Values(" & Y0 & "," & Y1 & "," & Y2 & ")"
                cmd.ExecuteNonQuery()
